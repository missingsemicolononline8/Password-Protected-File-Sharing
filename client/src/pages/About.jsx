...
const About = () => {
    return (
        <main className='flex'>
            <section className="text-gray-600 body-font flex-1 flex items-center">
                <div className="container px-5 md:px-36 py-24 mx-auto flex flex-wrap">
                    ...
                    <div className="md:w-3/5 md:pl-6">
                        ...
                        <div className="flex md:mt-4 mt-6">
                            <button className="inline-flex text-white bg-purple-500 border-0 py-1 px-4 focus:outline-none hover:bg-purple-600 rounded">Button</button>
                            <a className="text-purple-500 inline-flex items-center ml-4">Learn More
